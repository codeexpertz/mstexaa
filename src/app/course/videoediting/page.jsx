      ...
      <div className="min-h-screen flex items-center py-16 px-4 md:px-8 lg:px-16 overflow-hidden bg-[url('/herosection/Frame.svg')] bg-cover bg-center">
        <div className="flex flex-col lg:flex-row items-center gap-12 w-full max-w-7xl mx-auto">
          ...
          >
            ...
            >
              The Complete Social <br />
              <span className="text-black">
                Media Video Editing Masterclass
              </span>
            </motion.h1>
            ...
            >
              ...
              Your career in data science starts here. Fast-track learning and
              interview prep. Grow skills at your own pace. Expand your earnings
              potential.{" "}
            </motion.p>
...
>
    ...
    Get Start
          ...
          >
            ...
            <div className="relative rounded-xl overflow-hidden flex-shrink-0">
              <img
                src="/courses/videoediting/herosection1.svg"
            ...
            <div className="relative rounded-xl overflow-hidden flex-shrink-0">
              <img
                src="/courses/videoediting/herosection2.svg"
                alt="Developer working on laptop"
  ...
  {
    step: "Step 2",
    title: "Video Editing Software Mastery",
    description: [
      "Use Premiere/Resolve/Cut",
      "Learn editing tools",
      "Apply techniques"
    ],
  },
  ...
  {
    step: "Step 5",
    title: "Professional Workflow & Delivery",
    description: [
      "Efficient workflow",
      "Export settings",
      "Deliver videos"
