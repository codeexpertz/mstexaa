...
const Page = () => {
  ...
  const tabContent = {
    Team: {
      ...
      description:
        "Our team of cloud architects and engineers specializes in building secure, scalable, and cost-efficient infrastructures across AWS, Azure, and Google Cloud. With hands-on experience in migration, DevOps, and multi-cloud environments, we ensure your systems perform at enterprise-grade reliability and speed.",
    },
    Experience: {
      title: "Proven Cloud Experience",
      description:
        "We’ve partnered with organizations across industries to modernize their operations using cloud-native technologies. From serverless computing to container orchestration and data storage optimization, our projects consistently deliver improved uptime, flexibility, and reduced operational costs.",
    },
    Approach: {
      title: "End-to-End Cloud Strategy",
      description:
        "Our approach covers every stage of your cloud journey — from assessment and architecture design to deployment, automation, and continuous optimization. By integrating best practices for security, scalability, and compliance, we help you maximize the full potential of cloud computing while ensuring long-term business agility.",
    },
  };
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              We deliver scalable and secure cloud solutions that enhance
              performance, streamline operations, and support your business
              growth.{" "}
            </motion.p>
              ...
              >
                <div>
                  <motion.img
                    ...
                    src="/services/cloud-computing/infrastructure.svg"
                ...
                >
                  We architect secure and scalable cloud infrastructures
                  designed for performance, reliability, and cost efficiency.
                </motion.p>
              </motion.article>
              ...
              >
                <div>
                  <motion.img
                    ...
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.8, delay: 0.1 }}
                    src="/services/cloud-computing/migration.svg"
                ...
                >
                  Seamlessly move your applications and data to the cloud with
                  zero downtime and complete data integrity.
                </motion.p>
              </motion.article>
              ...
              >
                <div>
                  <motion.img
                    ...
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.8, delay: 0.1 }}
                    src="/services/cloud-computing/security.svg"
                ...
                >
                  We implement advanced security protocols and compliance
                  frameworks to protect your digital assets in the cloud.
                </motion.p>
              </motion.article>
            </motion.div>
              ...
              >
                <div>
                  <motion.img
                    ...
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.8, delay: 0.1 }}
                    src="/services/cloud-computing/devops.svg"
                  ...
                  <motion.h3
                    variants={fadeInUp}
                    className="text-lg font-bold">DevOps & Automation</motion.h3>
                </div>
                <motion.p
                  variants={fadeInUp}
                  className="mt-2 text-xs font-medium leading-relaxed text-[#00000080]"
                >
                  Accelerate deployment cycles and improve collaboration with
                  CI/CD pipelines and automated cloud workflows.
                </motion.p>
              </motion.article>
              ...
              >
                <div>
                  <motion.img
                    ...
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.8, delay: 0.1 }}
                    src="/services/cloud-computing/monitoring.svg"
                    alt="Cloud Monitoring & Optimization"
                    className="mb-4 h-24 w-24"
                    aria-hidden="true"
                  />
                  <motion.h3
                ...
                <motion.p
                  ...
                  className="mt-2 text-xs font-medium leading-relaxed text-[#00000080]"
                >
                  Monitor, analyze, and optimize cloud performance to ensure
              ...
              >
                <div>
                  <motion.img
                    ...
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.8, delay: 0.1 }}
                    src="/services/cloud-computing/multicloud.svg"
                    alt="Multi-Cloud & Hybrid Solutions"
                    className="mb-4 h-24 w-24"
                    aria-hidden="true"
                  />
                  <motion.h3
                ...
                >
                  Integrate multiple cloud platforms or hybrid setups for
                  flexibility, resilience, and seamless data management.
                </motion.p>
              </motion.article>
            </motion.div>
          </motion.div>
