...
const Page = () => {
  ...
  const tabContent = {
    Team: {
      ...
      description:
        "Our design process starts with people. By understanding user goals and pain points, we craft experiences that are simple, intuitive, and engaging. From wireframes to final interfaces, every detail builds trust while driving clear business results.",
    },
    Experience: {
      title: "Data-First Strategies",
      description:
        "We combine research, analytics, and usability testing to back every design choice with evidence. Instead of guessing, we validate with real user behavior. This approach guarantees solutions that not only look beautiful but perform flawlessly. Data fuels our designs - keeping your product effective, scalable, and conversion-focused.",
    },
    Approach: {
      title: "End-to-End Support",
      description:
        "Technology evolves, and so do user expectations. Our design team focuses on timeless solutions that adapt easily to emerging trends and devices. We integrate scalability, accessibility, and brand alignment into every project so your digital product stays competitive, sustainable, and future-proof in a fast-changing market.",
    },
  };
  ...
  return (
    <main className="min-h-[100svh]">
      ...
      >
        ...
        >
          ...
          >
            ...
            <motion.p
              variants={fadeInUp}
              className="mt-5 text-[#000000] leading-relaxed font-medium max-w-lg"
            >
              From concept to launch, we design intuitive websites, apps, and
              SaaS products that help your digital projects perform better.
            </motion.p>
      ...
      >
        ...
        <div className="pointer-events-none hidden md:block absolute z-0 -bottom-10 -right-10">
          <svg
            width="300"
            height="300"
            viewBox="0 0 273 517"
              ...
              >
                <div>
                  <motion.img
                    ...
                    src="/services/digital-desgining/wireframes.svg"
                ...
                <motion.p
                  variants={fadeInUp}
                  className="mt-2 md:w-[300px] font-medium text-xs leading-relaxed text-muted-foreground text-[#00000080]"
                >
                  We map ideas into wireframes and interactive prototypes,
                  helping visualize journeys before development.
                </motion.p>
              </motion.article>
              ...
              >
                <div>
                  <motion.img
                    ...
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.8, delay: 0.1 }}
                    src="/services/digital-desgining/app.svg"
                  ...
                  <motion.h3
                    variants={fadeInUp}
                    className="text-lg font-bold">App Interface Design</motion.h3>
                </div>
                <motion.p
                  variants={fadeInUp}
                  className="mt-2 font-medium text-xs leading-relaxed text-muted-foreground text-[#00000080]"
                >
                  We craft seamless mobile experiences that feel intuitive and
                  engaging with best-practice mobile UI/UX.
                </motion.p>
              </motion.article>
              ...
              >
                <div>
                  <motion.img
                    ...
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.8, delay: 0.1 }}
                    src="/services/digital-desgining/design.svg"
                    alt="Design Systems & UI Kits"
                    className="mb-4 h-24 w-24"
                    aria-hidden="true"
                  />
                  <motion.h3
                ...
                <motion.p
                  variants={fadeInUp}
                  className="mt-2 text-xs font-medium leading-relaxed text-muted-foreground text-[#00000080]"
                >
                  Reusable, consistent design systems that streamline workflows
                  and maintain brand harmony across platforms.
                </motion.p>
              </motion.article>
            </motion.div>
            ...
            >
              ...
              >
                ...
                <motion.p
                  ...
                  className="mt-2 text-xs font-medium leading-relaxed text-muted-foreground text-[#00000080]"
                >
                  We test early and often to catch issues before launch,
                  ensuring maximum clarity, speed, and satisfaction.
                </motion.p>
              </motion.article>
              ...
              >
                <div>
                  <motion.img
                    ...
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.8, delay: 0.1 }}
                    src="/services/digital-desgining/web.svg"
                  ...
                  <motion.h3
                    variants={fadeInUp}
                    className="text-lg font-bold">Web Application Design</motion.h3>
                </div>
                <motion.p
                  variants={fadeInUp}
                  className="mt-2 text-xs font-medium leading-relaxed text-muted-foreground text-[#00000080]"
                >
                  Scalable, conversion-focused web apps that merge usability
                  with high-performing visual aesthetics.
                </motion.p>
              </motion.article>
              ...
              >
                ...
                <motion.p
                  variants={fadeInUp}
                  className="mt-2 md:w-[350px] font-medium text-xs leading-relaxed text-muted-foreground text-[#00000080]"
                >
                  We begin every project by deeply understanding your users —
                  their needs, pain points, behaviors, and goals. usability
                  testing, we gather insights.
                </motion.p>
              </motion.article>
            </motion.div>
          </motion.div>
