...
const Page = () => {
  ...
  const tabContent = {
    Team: {
      title: "Marketing That Moves Revenue",
      description:
        "Your business doesn’t just need clicks; it needs paying customers. We build campaigns that link awareness to sales, creating strategies that directly fuel your bottom line. Every campaign is designed with revenue growth as the true measure of success.",
    },
    Experience: {
      title: "Insights That Beat Guesswork",
      description:
        "Wasted budgets happen when marketing is built on assumptions. Our team digs into customer behavior, search intent, and competitor moves to deliver campaigns backed by actionable insights. You don’t pay for experiments - you pay for proven, data-driven strategies.",
    },
    Approach: {
      title: "Growth Without Extra Complexity",
      description:
        "Marketing can feel overwhelming - too many tools, too many tactics. We cut through the noise with clear, simple solutions that scale with your business. From SEO to paid ads, we manage the hard part so you can focus on running your company.",
    },
  };
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Mstexa provides custom digital marketing solutions that drive
              real results, backed by proven internet marketing expertise for
              your business.
            </motion.p>
              ...
              >
                <div>
                  <motion.img
                    ...
                    src="/services/digital-marketing/seo.svg"
                ...
                >
                  Gain visibility where it matters most. We optimize your site,
                  build authority with quality content, and attract customers
              ...
              >
                <div>
                  <motion.img
                    ...
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.8, delay: 0.1 }}
                    src="/services/digital-marketing/social.svg"
                  ...
                  <motion.h3
                    variants={fadeInUp}
                    className="text-lg font-bold">Social Media Campaigns</motion.h3>
                </div>
                <motion.p
                  variants={fadeInUp}
                  className="mt-2 font-medium text-xs leading-relaxed text-[#00000080]"
                >
                  Build stronger connections. We create targeted social
                  campaigns that spark conversations and grow your online
                  community.
                </motion.p>
              </motion.article>
              ...
              >
                <div>
                  <motion.img
                    ...
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.8, delay: 0.1 }}
                    src="/services/digital-marketing/advertising.svg"
                ...
                >
                  Capture attention fast. Our PPC campaigns generate leads and
                  sales with precise targeting and data-driven bidding
                  strategies.
                </motion.p>
              </motion.article>
            </motion.div>
              ...
              >
                <div>
                  <motion.img
                    ...
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.8, delay: 0.1 }}
                    src="/services/digital-marketing/email.svg"
                ...
                <motion.p
                  ...
                  className="mt-2 text-xs font-medium leading-relaxed text-[#00000080]"
                >
                  Nurture customers with personalized email flows that drive
                  engagement, repeat sales, and long-term loyalty.
                </motion.p>
              </motion.article>
              ...
              >
                <div>
                  <motion.img
                    ...
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.8, delay: 0.1 }}
                    src="/services/digital-marketing/brand.svg"
                    alt="Brand Strategy & Messaging"
                    className="mb-4 h-24 w-24"
                    aria-hidden="true"
                  />
                  <motion.h3
                ...
                <motion.p
                  ...
                  className="mt-2 text-xs font-medium leading-relaxed text-[#00000080]"
                >
                  Clarify your brand voice and position. We develop messaging
                  that makes your business unforgettable in your market.
                </motion.p>
              </motion.article>
              ...
              >
                <div>
                  <motion.img
                    ...
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.8, delay: 0.1 }}
                    src="/services/digital-marketing/analytics.svg"
                ...
                >
                  See exactly what’s working. We track KPIs with precision,
                  giving you clear reporting and actionable insights to improve
                  performance.
                </motion.p>
              </motion.article>
            </motion.div>
