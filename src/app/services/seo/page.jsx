...
const Page = () => {
  ...
  const tabContent = {
    Team: {
      ...
      description:
        "Our SEO strategists, content specialists, and technical analysts work together to elevate your online visibility. With years of experience across diverse industries, our team builds data-driven strategies tailored to your business goals — driving sustainable traffic, better rankings, and higher conversions.",
    },
    Experience: {
      title: "Proven SEO Results",
      description:
        "We’ve helped brands grow from local recognition to global visibility through ethical, long-term SEO practices. Our experience spans on-page optimization, link building, technical SEO, and content strategy — backed by performance analytics that demonstrate real ROI. Every campaign is built on measurable impact and continuous improvement.",
    },
    Approach: {
      title: "Holistic Optimization Approach",
      description:
        "Our SEO process goes beyond keywords. We analyze your audience, competitors, and digital ecosystem to uncover growth opportunities. By combining technical optimization, quality content, and smart automation, we ensure your site ranks higher, loads faster, and converts better — across every search engine and device.",
    },
  };
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              We boost your online presence with data-driven SEO strategies that
              improve visibility, increase traffic, and drive meaningful
              conversions.
            </motion.p>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  We enhance your website structure, content, and metadata to
              ...
              <motion.article
                ...
                transition={{ duration: 0.6 }}
                whileHover={{ y: -5 }}
                className="rounded-2xl bg-white border border-border bg-card p-6 md:p-8 shadow-sm hover:shadow-md flex flex-col"
              >
                <div>
                  <motion.img
                    initial={{ opacity: 0 }}
                ...
                >
                  Boost domain authority and credibility through ethical
                  link-building and strategic digital outreach campaigns.
                </motion.p>
              </motion.article>
              ...
              >
                <div>
                  <motion.img
                    ...
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.8, delay: 0.1 }}
                    src="/services/seo/technical.svg"
                    alt="Technical SEO Audits"
                    className="mb-4 h-24 w-24"
                    aria-hidden="true"
                  />
                  <motion.h3
                    variants={fadeInUp}
                    className="text-lg font-bold">Technical SEO Audits</motion.h3>
                </div>
                <motion.p
                  variants={fadeInUp}
                  className="mt-2 text-xs font-medium leading-relaxed text-[#00000080]"
                >
                  We conduct in-depth technical audits to identify and fix
                  crawl, speed, and indexing issues affecting performance.
                </motion.p>
              </motion.article>
            </motion.div>
            ...
            >
              ...
              >
                ...
                <motion.p
                  ...
                  className="mt-2 text-xs font-medium leading-relaxed text-[#00000080]"
                >
                  Identify high-value keywords and build data-driven SEO
                  strategies that attract qualified, organic traffic.
                </motion.p>
              </motion.article>
              ...
              >
                <div>
                  ...
                  <motion.h3
                    variants={fadeInUp}
                    className="text-lg font-bold">Content Optimization</motion.h3>
                </div>
                <motion.p
                  variants={fadeInUp}
                  className="mt-2 text-xs font-medium leading-relaxed text-[#00000080]"
                >
                  We optimize existing content and create SEO-friendly copy that
                  drives engagement and improves rankings.
                </motion.p>
              </motion.article>
              ...
              <motion.article
                ...
                transition={{ duration: 0.6 }}
                whileHover={{ y: -5 }}
                className="sm:col-span-2 lg:col-span-2 rounded-2xl bg-white border border-border bg-card p-6 md:p-8 shadow-sm hover:shadow-md flex flex-col"
              >
                <div>
                  <motion.img
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.8, delay: 0.1 }}
                    src="/services/seo/analytics.svg"
                    alt="Analytics & Performance Tracking"
                    className="mb-4 h-24 w-24"
                    aria-hidden="true"
                  />
                  <motion.h3
                ...
                >
                  Track progress, measure conversions, and refine SEO campaigns
