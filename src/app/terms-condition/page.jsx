            ...
            <ol>
              <ul className="px-10">
                <li>
                  ...
                  by their own terms and conditions), Mstexa Ltd,  the
                ...
                <li>
                 ...
                 by Mstexa Ltd and acting in the course of their employment
                  or (ii) engaged as a consultant or otherwise providing
                  services to  Mstexa Ltd and accessing the Website in
              ...
              <ul className="px-10">
                <li>
                  ...
                  is the property of  Mstexa Ltd,  our affiliates or other
              ...
              <ul className="px-10">
                <li>
                  ...
                  of Mstexa Ltd  or that of our affiliates.{" "}
                </li>{" "}
                <br />
                <li>
              ...
              <ul className="px-10">
                <li>
                  ...
                  Mstexa Ltd makes available through the Website (the
                  ...
                  satisfactory quality. Mstexa Ltd is under no obligation to
                  update information on the Website.
                </li>{" "}
                <br />
                <li>
                  Whilst  Mstexa Ltd  uses reasonable endeavours to ensure
                ...
                <br />
                <li>
                 Mstexa Ltd accepts no liability for any disruption or
                  non-availability of the Website.
                </li>{" "}
                <br />
                <li>
                 Mstexa Ltd reserves the right to alter, suspend or
              ...
              <ul className="px-10">
                ...
                <br />
                <li>
                  To the maximum extent permitted by law, Mstexa Ltd accepts
              ...
              <ul className="px-10">
                <li>
                  ⦁ Mstexa Ltd is a company incorporated in England and
                ...
                <br />
                <li>
                  You can contact Mstexa Ltd by email on
                  info@codeexpertz.com
                </li>{" "}
              </ul>
            </ol>
          </div>
