...
const PartneringWithCodeExpert = () => {
  const items = [
    {
    ...
    },
    {
      ...
      description: "We take great satisfaction in always being reachable for our client.",
      side: "left"
    },
    {
      title: "Teamwork",
      description: "To guarantee successful results, our experts work closely with client.",
      side: "left"
    },
    {
      title: "Client Centered",
      description: "We put your need first and build good relationships with customers.",
      side: "right"
    },
    {
      title: "Sincerity",
...
export default PartneringWithCodeExpert;